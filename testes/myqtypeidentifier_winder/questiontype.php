<?php
/**
 * The question type class for the My Question Type Name question type.
 *
 * @copyright &copy; 2006 winderdias
 * @author winderdias@gmail.com
 * @license http://www.gnu.org/copyleft/gpl.html GNU Public License
 * @package YOURPACKAGENAME
 *//** */

/**
 * The My Question Type Name question class
 *
 * TODO give an overview of how the class works here.
 */
class myqtypeidentifier_qtype extends default_questiontype {

    function name() {
        return 'myqtypeidentifier';
    }
    ...
    function print_question_formulation_and_controls(&$question, &$state, $cmoptions, $options) {
        ...
        include("$CFG->dirroot/question/type/myqtypeidentifier/display.html");
    }
...
question_register_questiontype(new myqtypeidentifier_qtype());
?>
